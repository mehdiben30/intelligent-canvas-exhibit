...
For this project, our team used a lighter model, GPT-4 nano, instead of the models used in the original paper, which employed GPT-3.5 Turbo. I specifically worked on fine-tuning this smaller model using the OpenAI API and evaluating its performance across several datasets in few-shot learning scenarios. Due to Paris Cité's intellectual property policies, I am unable to publicly share the code or results, as they are considered proprietary to the institution.`,
