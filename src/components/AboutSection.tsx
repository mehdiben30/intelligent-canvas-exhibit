    ...
    <section className="min-h-screen py-20 px-6 bg-gradient-to-b from-porcelain to-porcelain/50">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="space-y-12">
          {/* Emobot Experience */}
          <div className="border-l-2 border-neutral-300 pl-8 relative">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-neutral-600 font-medium">June 2025 - September 2025</p>
                <p className="text-neutral-700 font-medium mt-1">Research Paper Implementation & MLOps</p>
              </div>
          ...
          <div className="border-l-2 border-neutral-300 pl-8 relative">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-neutral-600 font-medium">April 2024 - July 2024</p>
              </div>
              <ul className="space-y-2 text-black/80 leading-relaxed">
                <li className="flex items-start">
                  <span className="text-neutral-500 mr-3 mt-1">●</span>
